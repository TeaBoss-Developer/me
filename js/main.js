...
if(domain == '' || domain == null){
	document.title = '无名 - 个人主页';
	//document.getElementById(".title").innerHTML 
	document.getElementsByClassName("title")[0].innerHTML="无名 - 个人主页";
	document.getElementsByClassName("title")[1].innerHTML="无名 - 个人主页";
}else if(domain == 'www.52svip.cn' || domain == '52svip.cn'){
    document.title = '无名的故事';
	document.getElementsByClassName("title")[0].innerHTML="无名的故事";
	document.getElementsByClassName("title")[1].innerHTML="无名的故事";
}else{
    document.title = '初忆往昔';
	document.getElementsByClassName("title")[0].innerHTML="初忆往昔";
	document.getElementsByClassName("title")[1].innerHTML="初忆往昔";
}
//alert(domain);
//console.log(domain);
